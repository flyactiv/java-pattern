...
import com.example.lesson18.repository.ManufactureRepository;
...
//    private final ManufactureRepository manufactureRepository;
    ...
    public List<Manufacture> findManufactureByName(String name) {
    ...
    public List<Manufacture> findManufactureByAddress(String address) {
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaQuery<Manufacture> cq = cb.createQuery(Manufacture.class);
